...
enum {
        ...
        END_SESSION_DIALOG_CONFIRMED_REBOOT_MENU,
        NUMBER_OF_SIGNALS
};
...
gsm_shell_class_init (GsmShellClass *shell_class)
{
        ...
        signals [END_SESSION_DIALOG_CONFIRMED_REBOOT_MENU] =
                g_signal_new ("end-session-dialog-confirmed-reboot-menu",
                              G_OBJECT_CLASS_TYPE (object_class),
                              G_SIGNAL_RUN_LAST,
                              G_STRUCT_OFFSET (GsmShellClass, end_session_dialog_confirmed_reboot_menu),
                              NULL, NULL, NULL,
                              G_TYPE_NONE, 0);
                                   ...
                                   GsmShell   *shell)
{
        struct {
                ...
                { "ConfirmedRebootMenu", END_SESSION_DIALOG_CONFIRMED_REBOOT_MENU },
