...
struct _GsmSystemInterface
{
        ...
        gboolean (* can_restart_to_firmware) (GsmSystem *system);
        void     (* set_restart_to_firmware) (GsmSystem *system,
                                              gboolean   enable);
...
gboolean   gsm_system_can_restart_to_firmware (GsmSystem *system);

void       gsm_system_set_restart_to_firmware (GsmSystem *system,
                                               gboolean   enable);
